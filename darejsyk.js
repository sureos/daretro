...
let Pswd = 'trojan';
const proxyIPs = ['eu.cmbaby.mom','usa.cmbaby.mom','bestproxy.onecf.eu.org','cdn.xn--b6gac.eu.org', 'cdn-all.xn--b6gac.eu.org', 'cdn.anycast.eu.org', 'ts.hpc.tw']; //workers.cloudflare.cyou bestproxy.onecf.eu.org cdn-all.xn--b6gac.eu.org cdn.xn--b6gac.eu.org
